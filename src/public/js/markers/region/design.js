...
function defaultRegionMarkerStyle(level = "dong", design = activeRegionMarkerDesign(level)) {
  ...
  return {
    ...
    labelFontSize: defaultStyle.labelFontSize ?? 11,
    valuePrefixFontSize: defaultStyle.valuePrefixFontSize ?? 10,
    valueFontSize: defaultStyle.valueFontSize ?? 26,
    valueSuffixFontSize: defaultStyle.valueSuffixFontSize ?? 10,
    sigunguFontSize: defaultStyle.sigunguFontSize ?? 10,
    sidoFontSize: defaultStyle.sidoFontSize ?? 10,
    nationalFontSize: defaultStyle.nationalFontSize ?? 10,
    rankValueFontSize: defaultStyle.rankValueFontSize ?? 11,
    ...
    rankRowHeight: defaultStyle.rankRowHeight ?? 19,
