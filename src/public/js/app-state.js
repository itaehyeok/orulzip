...
const state = {
  ...
  clientConfig: { maps: { provider: "naver", naverKeyId: "" } },
  zoomNaverMap: null,
  zoomNaverOverlays: [],
  ...
  mapRankingTargetLevel: "",
  mapRankingTargetManual: false,
  mapRankingMode: "viewport",
  mapGroupRankingMode: "country",
  mapRankingDongScope: null,
  mapRankingScopes: null,
  mapRankingRequestId: 0,
  mapScopedRankingActiveSignature: "",
  mapScopedRankingPendingSignature: "",
  mapGroupRankingActiveSignature: "",
  mapGroupRankingPendingSignature: "",
...
const els = {
  ...
  mapLoadingOverlay: document.querySelector("#mapLoadingOverlay"),
  mapLoadingLabel: document.querySelector("[data-map-loading-label]"),
  ...
  analyticsLocationRows: document.querySelector("#analyticsLocationRows"),
  analyticsDeviceRows: document.querySelector("#analyticsDeviceRows"),
  analyticsBrowserRows: document.querySelector("#analyticsBrowserRows"),
  analyticsOsRows: document.querySelector("#analyticsOsRows"),
  analyticsLanguageRows: document.querySelector("#analyticsLanguageRows"),
