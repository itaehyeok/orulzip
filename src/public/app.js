...
const defaultMapHeaderDesignId = "charcoal";
...
const mapHeaderDesignVariants = [
  mapHeaderDesign("charcoal", "01 차콜", { headerBg: "#222831", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.12)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.68)", searchIcon: "#f2c94c", chipBg: "#ffffff", chipActiveBg: "#f3f4f6", chipActiveBorder: "#111827", chipActiveText: "#111827", periodBg: "#ffffff", mapWater: "#c9ddec", mapLand: "#e3eadc", mapRoad: "#e8bd77" }),
  mapHeaderDesign("blue-steel", "02 블루 스틸", { headerBg: "#1e3a5f", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.14)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.72)", searchIcon: "#cce7ff", chipBg: "#ffffff", chipActiveBg: "#e3effb", chipActiveBorder: "#1e5b92", chipActiveText: "#164e7a", periodBg: "#f8fbff", mapWater: "#c7e2f6", mapLand: "#e6efdf", mapRoad: "#e9bd76" }),
  mapHeaderDesign("midnight-navy", "03 미드나잇 네이비", { headerBg: "#101828", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.13)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.72)", searchIcon: "#84caff", chipBg: "#ffffff", chipActiveBg: "#dbeafe", chipActiveBorder: "#2563eb", chipActiveText: "#1e40af", periodBg: "#f8fafc", mapWater: "#c5def2", mapLand: "#e4eddc", mapRoad: "#e9bd71" }),
  mapHeaderDesign("forest-deep", "04 포레스트 딥", { headerBg: "#14532d", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.15)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.76)", searchIcon: "#bbf7d0", chipBg: "#ffffff", chipActiveBg: "#dcfce7", chipActiveBorder: "#15803d", chipActiveText: "#166534", periodBg: "#fbfffb", mapWater: "#c8e5ef", mapLand: "#d8eccd", mapRoad: "#e5c074" }),
  mapHeaderDesign("burgundy", "05 버건디", { headerBg: "#5f1729", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.14)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.72)", searchIcon: "#fecdd3", chipBg: "#ffffff", chipActiveBg: "#ffe4e6", chipActiveBorder: "#be123c", chipActiveText: "#9f1239", periodBg: "#fffafa", mapWater: "#c9e1f0", mapLand: "#e8efde", mapRoad: "#e7bd78" }),
  mapHeaderDesign("espresso", "06 에스프레소", { headerBg: "#3b2f2f", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.14)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.74)", searchIcon: "#f5d0a9", chipBg: "#ffffff", chipActiveBg: "#fef3c7", chipActiveBorder: "#b45309", chipActiveText: "#92400e", periodBg: "#fffaf2", mapWater: "#cddfe9", mapLand: "#e8ecd9", mapRoad: "#e2b96e" }),
  mapHeaderDesign("slate-teal", "07 슬레이트 틸", { headerBg: "#164e63", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.14)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.72)", searchIcon: "#a5f3fc", chipBg: "#ffffff", chipActiveBg: "#cffafe", chipActiveBorder: "#0891b2", chipActiveText: "#0e7490", periodBg: "#f8feff", mapWater: "#bfe4f0", mapLand: "#e0eddb", mapRoad: "#e9c073" }),
  mapHeaderDesign("royal-indigo", "08 로열 인디고", { headerBg: "#312e81", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.15)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.74)", searchIcon: "#c7d2fe", chipBg: "#ffffff", chipActiveBg: "#e0e7ff", chipActiveBorder: "#4f46e5", chipActiveText: "#4338ca", periodBg: "#fbfbff", mapWater: "#c7def1", mapLand: "#e7eedf", mapRoad: "#eac176" }),
  mapHeaderDesign("graphite-gold", "09 그래파이트 골드", { headerBg: "#1f2937", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.13)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.7)", searchIcon: "#fbbf24", chipBg: "#ffffff", chipActiveBg: "#fef3c7", chipActiveBorder: "#d97706", chipActiveText: "#92400e", periodBg: "#ffffff", mapWater: "#c9deea", mapLand: "#e5ecdf", mapRoad: "#e0b867" }),
  mapHeaderDesign("cobalt", "10 코발트", { headerBg: "#1d4ed8", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.16)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.78)", searchIcon: "#dbeafe", chipBg: "#ffffff", chipActiveBg: "#dbeafe", chipActiveBorder: "#1d4ed8", chipActiveText: "#1e40af", periodBg: "#ffffff", mapWater: "#c2e0f5", mapLand: "#e4eedf", mapRoad: "#e7bf77" }),
  mapHeaderDesign("dark-olive", "11 다크 올리브", { headerBg: "#3f6212", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.15)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.74)", searchIcon: "#d9f99d", chipBg: "#ffffff", chipActiveBg: "#ecfccb", chipActiveBorder: "#65a30d", chipActiveText: "#4d7c0f", periodBg: "#fefff9", mapWater: "#cbe1ea", mapLand: "#d9ebc8", mapRoad: "#dfbd70" }),
  mapHeaderDesign("black-blue", "12 블랙 블루", { headerBg: "#0b1220", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.13)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.68)", searchIcon: "#60a5fa", chipBg: "#ffffff", chipActiveBg: "#dbeafe", chipActiveBorder: "#2563eb", chipActiveText: "#1d4ed8", periodBg: "#f8fafc", mapWater: "#c8ddeb", mapLand: "#e4ecdd", mapRoad: "#e4b96f" })
];
