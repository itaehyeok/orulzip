...
const defaultMapHeaderDesignId = "airbnb-coral";
...
const mapHeaderDesignVariants = [
  mapHeaderDesign("airbnb-coral", "01 에어비앤비 스타일", { headerBg: "#e6425f", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.18)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.78)", searchIcon: "#ffe1e8", chipBg: "#ffffff", chipActiveBg: "#fff1f4", chipActiveBorder: "#d93556", chipActiveText: "#b42342", periodBg: "#fff8fa", mapWater: "#c9e3f1", mapLand: "#e9efe1", mapRoad: "#e8be75" }),
  mapHeaderDesign("toss-blue", "02 토스 스타일", { headerBg: "#155ee8", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.16)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.78)", searchIcon: "#dbeafe", chipBg: "#ffffff", chipActiveBg: "#e8f1ff", chipActiveBorder: "#155ee8", chipActiveText: "#124ab8", periodBg: "#f7fbff", mapWater: "#c3e2f6", mapLand: "#e5eedf", mapRoad: "#e6bd76" }),
  mapHeaderDesign("daangn-orange", "03 당근 스타일", { headerBg: "#e85f13", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.18)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.78)", searchIcon: "#ffedd5", chipBg: "#ffffff", chipActiveBg: "#fff4e8", chipActiveBorder: "#e85f13", chipActiveText: "#b9470d", periodBg: "#fffaf5", mapWater: "#c9e0ef", mapLand: "#e8efdf", mapRoad: "#e2b36b" }),
  mapHeaderDesign("naver-green", "04 네이버 스타일", { headerBg: "#0aa45f", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.17)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.78)", searchIcon: "#dcfce7", chipBg: "#ffffff", chipActiveBg: "#e8fff2", chipActiveBorder: "#0aa45f", chipActiveText: "#087a49", periodBg: "#f8fffb", mapWater: "#c7e4f0", mapLand: "#dcefd5", mapRoad: "#e4bd72" }),
  mapHeaderDesign("kakao-ink", "05 카카오 스타일", { headerBg: "#2b2418", headerText: "#fff4bf", searchBg: "rgba(255,238,145,0.16)", searchText: "#fff8d6", searchPlaceholder: "rgba(255,248,214,0.7)", searchIcon: "#f6d94c", chipBg: "#ffffff", chipActiveBg: "#fff6c7", chipActiveBorder: "#c99a06", chipActiveText: "#7a5b00", periodBg: "#fffdf0", mapWater: "#cbdfea", mapLand: "#e7ecd8", mapRoad: "#ddb769" }),
  mapHeaderDesign("baemin-mint", "06 배민 스타일", { headerBg: "#0f8f84", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.18)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.78)", searchIcon: "#ccfbf1", chipBg: "#ffffff", chipActiveBg: "#ecfeff", chipActiveBorder: "#0f8f84", chipActiveText: "#0f766e", periodBg: "#f8ffff", mapWater: "#bfe3ed", mapLand: "#e1eedb", mapRoad: "#e7c071" }),
  mapHeaderDesign("coupang-rocket", "07 쿠팡 스타일", { headerBg: "#26364c", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.15)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.72)", searchIcon: "#ffcf33", chipBg: "#ffffff", chipActiveBg: "#fff4db", chipActiveBorder: "#ef7d17", chipActiveText: "#b45309", periodBg: "#fffaf1", mapWater: "#c6dfef", mapLand: "#e5eddf", mapRoad: "#e6b867" }),
  mapHeaderDesign("musinsa-black", "08 무신사 스타일", { headerBg: "#111111", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.13)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.68)", searchIcon: "#e5e7eb", chipBg: "#ffffff", chipActiveBg: "#f3f4f6", chipActiveBorder: "#111111", chipActiveText: "#111111", periodBg: "#ffffff", mapWater: "#ccdfea", mapLand: "#e6ecdf", mapRoad: "#dfb86f" }),
  mapHeaderDesign("netflix-red", "09 넷플릭스 스타일", { headerBg: "#b91c1c", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.15)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.74)", searchIcon: "#fecaca", chipBg: "#ffffff", chipActiveBg: "#fee2e2", chipActiveBorder: "#b91c1c", chipActiveText: "#991b1b", periodBg: "#fffafa", mapWater: "#cbdfea", mapLand: "#e8edde", mapRoad: "#e4ba72" }),
  mapHeaderDesign("spotify-green", "10 스포티파이 스타일", { headerBg: "#0f7a3d", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.16)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.76)", searchIcon: "#bbf7d0", chipBg: "#ffffff", chipActiveBg: "#e9fbea", chipActiveBorder: "#0f7a3d", chipActiveText: "#166534", periodBg: "#fbfffb", mapWater: "#c7e2ef", mapLand: "#dcefcf", mapRoad: "#e1bc6e" }),
  mapHeaderDesign("linkedin-blue", "11 링크드인 스타일", { headerBg: "#075985", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.15)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.74)", searchIcon: "#bae6fd", chipBg: "#ffffff", chipActiveBg: "#e0f2fe", chipActiveBorder: "#075985", chipActiveText: "#075985", periodBg: "#f8fdff", mapWater: "#c2e4f3", mapLand: "#e4eddf", mapRoad: "#e7bf74" }),
  mapHeaderDesign("kurly-purple", "12 컬리 스타일", { headerBg: "#5b2180", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.16)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.74)", searchIcon: "#f0d4ff", chipBg: "#ffffff", chipActiveBg: "#f5e8ff", chipActiveBorder: "#7e22ce", chipActiveText: "#6b21a8", periodBg: "#fdf8ff", mapWater: "#c9dff0", mapLand: "#e7eddf", mapRoad: "#e6bf75" }),
  mapHeaderDesign("yanolja-pink", "13 야놀자 스타일", { headerBg: "#b91c68", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.16)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.74)", searchIcon: "#fbcfe8", chipBg: "#ffffff", chipActiveBg: "#fce7f3", chipActiveBorder: "#b91c68", chipActiveText: "#9d174d", periodBg: "#fff8fc", mapWater: "#c9e1f0", mapLand: "#e8eedf", mapRoad: "#e4bc73" }),
  mapHeaderDesign("oliveyoung-olive", "14 올리브영 스타일", { headerBg: "#496d16", headerText: "#ffffff", searchBg: "rgba(255,255,255,0.16)", searchText: "#ffffff", searchPlaceholder: "rgba(255,255,255,0.76)", searchIcon: "#d9f99d", chipBg: "#ffffff", chipActiveBg: "#f0f9dd", chipActiveBorder: "#496d16", chipActiveText: "#3f6212", periodBg: "#fefff8", mapWater: "#c9e0ea", mapLand: "#dcebc9", mapRoad: "#dfbb6e" })
];
